  ...
  return (
    <section>
        ...
        <div className="column small-12 text-center main-contact">
          <p>
            <a href="mailto:jainmukul1996@gmail.com">
              <img src={require("../media/email.svg")} alt="email icon" />
              <span className="roboto">jainmukul1996@gmail.com</span>
            </a>
          </p>
          <p>
            <a href="tel:++917221008771">
              <img src={require("../media/mobile.svg")} alt="mobile icon" />
              <span className="roboto">+91-7221-008-771</span>
            </a>
          </p>
        </div>
      </div>
      ...
      <div className="row align-center">
        <div
          className="small-1 small-centered contact-seprator"
      ...
      <div
        className="row align-center text-center"
        style={{ "margin-bottom": "40px" }}
      >
        <div className="columns">
          Hire me through{" "}
          <a href="https://codementor.io/mukuljainx" target="_blank">
            Codementor
          </a>
        </div>
      </div>
        ...
        <div className="column small-10 medium-10 small-centered text-center social-contact">
          <div className="row">
            <div className="column small-12 large-2 medium-4 large-offset-1">
              <p>
                <a href="https://github.com/mukuljainx" target="_blank">
                  <img src={require("../media/github.svg")} alt="github icon" />
                  /mukuljainx
                </a>
              </p>
            </div>
            <div className="column small-12 large-2 medium-4">
              <p>
                <a
                  href="https://www.linkedin.com/in/mukuljainx"
                  target="_blank"
                >
                  <img
            ...
            <div className="column small-12 large-2 medium-4 ">
              <p>
                <a href="https://www.facebook.com/mukuljainx" target="_blank">
                  <img
                    src={require("../media/facebook.svg")}
                    alt="facebook icon"
                  />
                  /mukuljainx
                </a>
            ...
            <div className="column small-12 large-2 medium-4">
              <p>
                <a href="https://plus.google.com/+MukulJainx" target="_blank">
                  <img src={require("../media/google.svg")} alt="google icon" />
                  /+mukuljainx
                </a>
              </p>
            </div>
