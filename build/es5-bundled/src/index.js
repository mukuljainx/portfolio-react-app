...
if(30<Math.abs(this._initScrollTop-scrollTop)||10<absDScrollTop){if(isScrollingDown&&scrollTop>=maxHeaderTop){top=maxHeaderTop}else if(!isScrollingDown&&scrollTop>=this._dHeight){top=this.condenses&&!this.fixed?this._dHeight:0}var scrollVelocity=dScrollTop/(now-this._lastTimestamp);this.style.transitionDuration=this._clamp((top-lastTop)/scrollVelocity,0,300)+"ms"}else{top=this._top}}}if(0===this._dHeight){progress=0<scrollTop?1:0}else{progress=top/this._dHeight}if(!forceUpdate){this._lastScrollTop=scrollTop;this._top=top;this._wasScrollingDown=isScrollingDown;this._lastTimestamp=now}if(forceUpdate||progress!==this._progress||lastTop!==top||0===scrollTop){this._progress=progress;this._runEffects(progress,top);this._transformHeader(top)}},/**
   ...
   */getScrollState:function getScrollState(){return{progress:this._progress,top:this._top}}});registerEffect("waterfall",{/** @this {Waterfall} */run:function run(){this.shadow=this.isOnScreen()&&this.isContentBelow()}});/**
     ...
     */var Waterfall=function Waterfall(){babelHelpers.classCallCheck(this,Waterfall);/** @type {boolean} */this.shadow};Polymer({/** @override */_template:html(_templateObject4_84bcd1102f9911eaa92735db92b9b07c()),is:"app-toolbar"});/**
    @license
...
styleSet.forEach(function(v){return styles.unshift(v)})}else if(userStyles){styles.push(userStyles)}return styles}}]);return LitElement}(UpdatingElement);_exports.LitElement=LitElement;/**
   ...
   */ /**
      ...
      */_exports.$litElement=litElement;var installMediaQueryWatcher=function installMediaQueryWatcher(mediaQuery,layoutChangedCallback){var mql=window.matchMedia(mediaQuery);mql.addListener(function(e){return layoutChangedCallback(e.matches)});layoutChangedCallback(mql.matches)};_exports.installMediaQueryWatcher=installMediaQueryWatcher;var mediaQuery={installMediaQueryWatcher:installMediaQueryWatcher};/**
   @license
   Copyright (c) 2018 The Polymer Project Authors. All rights reserved.
   This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
   The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
   ...
   */ /**
      ...
      */_exports.$metadata=metadata;var installRouter=function installRouter(locationUpdatedCallback){document.body.addEventListener("click",function(e){if(e.defaultPrevented||0!==e.button||e.metaKey||e.ctrlKey||e.shiftKey)return;var anchor=e.composedPath().filter(function(n){return"A"===n.tagName})[0];if(!anchor||anchor.target||anchor.hasAttribute("download")||"external"===anchor.getAttribute("rel"))return;var href=anchor.href;if(!href||-1!==href.indexOf("mailto:"))return;var location=window.location,origin=location.origin||location.protocol+"//"+location.host;if(0!==href.indexOf(origin))return;e.preventDefault();if(href!==location.href){window.history.pushState({},"",href);locationUpdatedCallback(location,e)}});window.addEventListener("popstate",function(e){return locationUpdatedCallback(window.location,e)});locationUpdatedCallback(window.location,null/* event */)};_exports.installRouter=installRouter;var router={installRouter:installRouter};_exports.$router=router;var hamBurgerIcon=html$1(_templateObject5_84bcd1102f9911eaa92735db92b9b07c());_exports.hamBurgerIcon=hamBurgerIcon;var icon={hamBurgerIcon:hamBurgerIcon};_exports.$icon=icon;var init=function init(cb){return installRouter(cb)};_exports.init=init;var routes=[{name:"home",route:"",displayName:"Home"},{name:"about",route:"about",displayName:"About"},{name:"work",route:"work",displayName:"Work"},{name:"contact",route:"contact",displayName:"Contact"}];_exports.routes=routes;var getPage=function getPage(location){var locationArray=location.pathname.split("/");if(2===locationArray.length){var page=locationArray[1]||"home";switch(page){case"home":{new Promise(function(res,rej){return _require.default(["./routes/home.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$home||{}});return"home"}case"about":{new Promise(function(res,rej){return _require.default(["./routes/about.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$about||{}});return page}case"work":{new Promise(function(res,rej){return _require.default(["./routes/work.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$work$1||{}});return page}case"contact":{new Promise(function(res,rej){return _require.default(["./routes/contact.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$contact||{}});return page}}}else if(3===locationArray.length){var _page=locationArray[1]||"home";if("work"===_page){new Promise(function(res,rej){return _require.default(["./routes/work-detail.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$workDetail$1||{}});return"workDetail"}}new Promise(function(res,rej){return _require.default(["./routes/error-404.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$error$404||{}});return"Error404"};_exports.getPage=getPage;var router$1={init:init,getPage:getPage,routes:routes};_exports.$router$1=router$1;var __decorate=void 0||function(decorators,target,key,desc){var c=arguments.length,r=3>c?target:null===desc?desc=Object.getOwnPropertyDescriptor(target,key):desc,d;if("object"===("undefined"===typeof Reflect?"undefined":babelHelpers.typeof(Reflect))&&"function"===typeof Reflect.decorate)r=Reflect.decorate(decorators,target,key,desc);else for(var i=decorators.length-1;0<=i;i--){if(d=decorators[i])r=(3>c?d(r):3<c?d(target,key,r):d(target,key))||r}return 3<c&&r&&Object.defineProperty(target,key,r),r},Menu=/*#__PURE__*/function(_LitElement){babelHelpers.inherits(Menu,_LitElement);function Menu(){var _this44;babelHelpers.classCallCheck(this,Menu);_this44=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(Menu).apply(this,arguments));_this44.page="";_this44.drawerOpened=!1;_this44._handleHumBurgerClick=function(event){_this44.dispatchEvent(new CustomEvent("humburger-click",{composed:!0,detail:{event:event}}))};_this44._handleDrawerOpenedChange=function(){_this44.dispatchEvent(new CustomEvent("drawer-opened-change",{composed:!0}))};return _this44}babelHelpers.createClass(Menu,[{key:"render",value:function render(){var _this45=this;return html$1(_templateObject6_84bcd1102f9911eaa92735db92b9b07c(),this._handleHumBurgerClick,hamBurgerIcon,routes.map(function(route){return html$1(_templateObject7_84bcd1102f9911eaa92735db92b9b07c(),_this45.page===route.name,route.route,route.displayName)}),this.drawerOpened,this._handleDrawerOpenedChange,routes.map(function(route){return html$1(_templateObject8_84bcd1102f9911eaa92735db92b9b07c(),_this45.page===route.name,route.route,route.displayName)}))}}],[{key:"styles",get:function get(){return[css(_templateObject9_84bcd1102f9911eaa92735db92b9b07c())]}}]);return Menu}(LitElement);__decorate([property({type:String})],Menu.prototype,"page",void 0);__decorate([property({type:Boolean})],Menu.prototype,"drawerOpened",void 0);Menu=__decorate([customElement("mx-menu")],Menu);var Menu$1=Menu;_exports.$menuDefault=Menu$1;var menu={default:Menu$1};_exports.$menu=menu;var __decorate$1=void 0||function(decorators,target,key,desc){var c=arguments.length,r=3>c?target:null===desc?desc=Object.getOwnPropertyDescriptor(target,key):desc,d;if("object"===("undefined"===typeof Reflect?"undefined":babelHelpers.typeof(Reflect))&&"function"===typeof Reflect.decorate)r=Reflect.decorate(decorators,target,key,desc);else for(var i=decorators.length-1;0<=i;i--){if(d=decorators[i])r=(3>c?d(r):3<c?d(target,key,r):d(target,key))||r}return 3<c&&r&&Object.defineProperty(target,key,r),r},PageViewElement=/*#__PURE__*/function(_LitElement2){babelHelpers.inherits(PageViewElement,_LitElement2);function PageViewElement(){var _this46;babelHelpers.classCallCheck(this,PageViewElement);_this46=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(PageViewElement).apply(this,arguments));_this46.active=!1;return _this46}// Only render this page if it's actually visible.
babelHelpers.createClass(PageViewElement,[{key:"shouldUpdate",value:function shouldUpdate(){return this.active}}]);return PageViewElement}(LitElement);_exports.PageViewElement=PageViewElement;__decorate$1([property({type:Boolean})],PageViewElement.prototype,"active",void 0);var pageViewElement={PageViewElement:PageViewElement};_exports.$pageViewElement=pageViewElement;var SharedStyles=css(_templateObject10_84bcd1102f9911eaa92735db92b9b07c());_exports.$sharedStylesDefault=SharedStyles;var sharedStyles={default:SharedStyles};_exports.$sharedStyles=sharedStyles;var __decorate$2=void 0||function(decorators,target,key,desc){var c=arguments.length,r=3>c?target:null===desc?desc=Object.getOwnPropertyDescriptor(target,key):desc,d;if("object"===("undefined"===typeof Reflect?"undefined":babelHelpers.typeof(Reflect))&&"function"===typeof Reflect.decorate)r=Reflect.decorate(decorators,target,key,desc);else for(var i=decorators.length-1;0<=i;i--){if(d=decorators[i])r=(3>c?d(r):3<c?d(target,key,r):d(target,key))||r}return 3<c&&r&&Object.defineProperty(target,key,r),r},SocialLinks=/*#__PURE__*/function(_LitElement3){babelHelpers.inherits(SocialLinks,_LitElement3);function SocialLinks(){babelHelpers.classCallCheck(this,SocialLinks);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SocialLinks).apply(this,arguments))}babelHelpers.createClass(SocialLinks,[{key:"render",value:function render(){return html$1(_templateObject11_84bcd1102f9911eaa92735db92b9b07c())}}],[{key:"styles",get:function get(){return[SharedStyles,css(_templateObject12_84bcd1102f9911eaa92735db92b9b07c())]}}]);return SocialLinks}(LitElement);SocialLinks=__decorate$2([customElement("mx-social-links")],SocialLinks);var SocialLinks$1=SocialLinks;_exports.$socialLinksDefault=SocialLinks$1;var socialLinks={default:SocialLinks$1};_exports.$socialLinks=socialLinks;var getDefaultStyle=function getDefaultStyle(){return css(_templateObject13_84bcd1102f9911eaa92735db92b9b07c())};_exports.$indexDefault=getDefaultStyle;var index={default:getDefaultStyle};_exports.$index=index;var __decorate$3=void 0||function(decorators,target,key,desc){var c=arguments.length,r=3>c?target:null===desc?desc=Object.getOwnPropertyDescriptor(target,key):desc,d;if("object"===("undefined"===typeof Reflect?"undefined":babelHelpers.typeof(Reflect))&&"function"===typeof Reflect.decorate)r=Reflect.decorate(decorators,target,key,desc);else for(var i=decorators.length-1;0<=i;i--){if(d=decorators[i])r=(3>c?d(r):3<c?d(target,key,r):d(target,key))||r}return 3<c&&r&&Object.defineProperty(target,key,r),r},App=/*#__PURE__*/function(_LitElement4){babelHelpers.inherits(App,_LitElement4);function App(){var _this47;babelHelpers.classCallCheck(this,App);_this47=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(App).call(this));_this47.appTitle="";_this47._page="";_this47._drawerOpened=!1;_this47.updateDrawerState=function(state){_this47._drawerOpened=state};_this47.updateCurrentPage=function(location){_this47._page=getPage(location)};// To force all event listeners for gestures to be passive.
// See https://www.polymer-project.org/3.0/docs/devguide/settings#setting-passive-touch-gestures
setPassiveTouchGestures(!0);return _this47}// @property({ type: Boolean })
...
return html$1(_templateObject14_84bcd1102f9911eaa92735db92b9b07c(),this._menuButtonClicked,this._drawerOpenedChanged,this._page,this._drawerOpened,"home"===this._page,"about"===this._page,"work"===this._page,"workDetail"===this._page,"contact"===this._page,"Error404"===this._page)}},{key:"firstUpdated",value:function firstUpdated(){var _this48=this;// installRouter((location: Location) => this.updateCurrentPage(location));
init(this.updateCurrentPage);// installOfflineWatcher(offline => (this._offline = offline));
installMediaQueryWatcher("(min-width: 460px)",function(){return _this48.updateDrawerState(!1)})}},{key:"updated",value:function updated(changedProps){if(changedProps.has("_page")){var pageTitle=this.appTitle+" - "+this._page[0].toUpperCase()+this._page.substr(1);updateMetadata({title:pageTitle,description:pageTitle// This object also takes an image property, that points to an img src.
})}}},{key:"_menuButtonClicked",value:function _menuButtonClicked(event){event.stopPropagation();event.preventDefault();this.updateDrawerState(!0)}},{key:"_drawerOpenedChanged",value:function _drawerOpenedChanged(e){this.updateDrawerState(!!e.target.drawerOpened)}}],[{key:"styles",get:function get(){return[getDefaultStyle()]}}]);return App}(LitElement);_exports.App=App;__decorate$3([property({type:String})],App.prototype,"appTitle",void 0);__decorate$3([property({type:String})],App.prototype,"_page",void 0);__decorate$3([property({type:Boolean})],App.prototype,"_drawerOpened",void 0);_exports.App=App=__decorate$3([customElement("mx-app")],App);var index$1={get App(){return App}};_exports.$index$1=index$1});