const workDetail = {
  mokku: {
    ...
    mainImg: "mokku.png",
    altMainImg: "Mokku",
    website: "https://mukuljainx.github.io/mokku/",
    github: "https://github.com/mukuljainx/mokku",
    about: [
    ...
    frontEndTech: "Chrome Extension • ReactJS • TypeScript",
    features: [
      "View all the Network calls in logs tab.",
      "Mock any call directly by clicking mock or edit already mocked API call.",
      "Create mocks for API which are in development phase.",
      "Mock a session by using record button, no reliability on server or internet ;)",
      "Test all the cases by changes response, create a bug free product.",
    ],
    shadow: true,
  },
  "smart-grid": {
