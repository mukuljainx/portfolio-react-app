...
$( "select" )
	.change(function() {
    	...
    	if(str == "Robotics")
    	{
            ...
            window.location.replace("./robo.html#/transporter");
            $('#Robotics').show();
    		$('#Management').hide();
    		$('#Coding').hide();
    		$('#Quizzing').hide();
    	...
    	if(str == "Management")
    	{
            ...
            window.location.replace("./robo.html#/sif");            
            $('#Robotics').hide();
    		$('#Management').show();
    		$('#Coding').hide();
    		$('#Quizzing').hide();
    	...
    	if(str == "Coding")
    	{
            ...
            window.location.replace("./robo.html#/event");            
        ...
        if(str == "Quizzing")
        {
            ...
            window.location.replace("./robo.html#/bigq");            
    		$('#Robotics').hide();
    		$('#Management').hide();
    		$('#Coding').hide();
    		$('#Quizzing').show();
    	...
    	if(str == "Astronomy")
    	{
            ...
            window.location.replace("./robo.html#/astrohunt");
    		$('#Robotics').hide();
    		$('#Management').hide();
    		$('#Coding').hide();
    		$('#Quizzing').hide();
    	...
    	if(str == "Literary")
    	{
            ...
            window.location.replace("./robo.html#/finderskeepers");
    		$('#Robotics').hide();
    		$('#Management').hide();
    		$('#Coding').hide();
    		$('#Quizzing').hide();
