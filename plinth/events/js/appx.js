 var mainApp = angular.module("CompetitionEvent", ['ngRoute']);
         mainApp.config(['$routeProvider', function($routeProvider) {
            $routeProvider

  .when('/transporter',{
    controller : 'MainController',
    templateUrl : 'views/transportery.html'
  })
  .when('/robowar',{
    controller : 'MainController',
  ...
  .when('/robosoccer',{
    controller : 'MainController',
    templateUrl : 'views/robosoccerzz.html'
  })
  .when('/technovation',{
    controller : 'MainController',
