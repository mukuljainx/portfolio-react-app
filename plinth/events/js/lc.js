...
$( "select" )
	.change(function() {
    	...
    	if(str == "Robotics")
    	{
            ...
            window.location.replace("./lc.html#/transporter");
            $('#Robotics').show();
    		$('#Management').hide();
    		$('#Coding').hide();
    		$('#Quizzing').hide();
    	...
    	if(str == "Management")
    	{
            ...
            window.location.replace("./lc.html#/sif");            
            $('#Robotics').hide();
    		$('#Management').show();
    		$('#Coding').hide();
    		$('#Quizzing').hide();
    	...
    	if(str == "Coding")
    	{
            ...
            window.location.replace("./lc.html#/event");            
        ...
        if(str == "Quizzing")
        {
            ...
            window.location.replace("./lc.html#/bigq");            
    		$('#Robotics').hide();
    		$('#Management').hide();
    		$('#Coding').hide();
    		$('#Quizzing').show();
    	...
    	if(str == "Astronomy")
    	{
            ...
            window.location.replace("./lc.html#/astrohunt");
    		$('#Robotics').hide();
    		$('#Management').hide();
    		$('#Coding').hide();
    		$('#Quizzing').hide();
    	...
    	if(str == "Literary")
    	{
            ...
            window.location.replace("./lc.html#/finderskeepers");
    		$('#Robotics').hide();
    		$('#Management').hide();
    		$('#Coding').hide();
    		$('#Quizzing').hide();
