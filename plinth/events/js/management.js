...
$( "select" )
	.change(function() {
    	...
    	if(str == "Robotics")
    	{
            ...
            window.location.replace("./management.html#/transporter");
            $('#Robotics').show();
    		$('#Management').hide();
    		$('#Coding').hide();
    		$('#Quizzing').hide();
    	...
    	if(str == "Coding")
    	{
            ...
            window.location.replace("./management.html#/event");            
        ...
        if(str == "Quizzing")
        {
            ...
            window.location.replace("./management.html#/bigq");            
    		$('#Robotics').hide();
    		$('#Management').hide();
    		$('#Coding').hide();
    		$('#Quizzing').show();
    	...
    	if(str == "Astronomy")
    	{
            ...
            window.location.replace("./management.html#/astrohunt");
    		$('#Robotics').hide();
    		$('#Management').hide();
    		$('#Coding').hide();
    		$('#Quizzing').hide();
    	...
    	if(str == "Literary")
    	{
            ...
            window.location.replace("./management.html#/finderskeepers");
    		$('#Robotics').hide();
    		$('#Management').hide();
    		$('#Coding').hide();
    		$('#Quizzing').hide();
