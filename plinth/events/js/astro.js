...
$( "select" )
	.change(function() {
    	...
    	if(str == "Robotics")
    	{
            ...
            window.location.replace("./astro.html#/transporter");
            $('#Robotics').show();
    		$('#Management').hide();
    		$('#Coding').hide();
    		$('#Quizzing').hide();
    	...
    	if(str == "Management")
    	{
            ...
            window.location.replace("./astro.html#/sif");            
            $('#Robotics').hide();
    		$('#Management').show();
    		$('#Coding').hide();
    		$('#Quizzing').hide();
    	...
    	if(str == "Coding")
    	{
            ...
            window.location.replace("./astro.html#/event");            
        ...
        if(str == "Quizzing")
        {
            ...
            window.location.replace("./astro.html#/bigq");            
    		$('#Robotics').hide();
    		$('#Management').hide();
    		$('#Coding').hide();
    		$('#Quizzing').show();
    	...
    	if(str == "Astronomy")
    	{
            ...
            window.location.replace("./astro.html#/astrohunt");
    		$('#Robotics').hide();
    		$('#Management').hide();
    		$('#Coding').hide();
    		$('#Quizzing').hide();
    	...
    	if(str == "Literary")
    	{
            ...
            window.location.replace("./astro.html#/finderskeepers");
    		$('#Robotics').hide();
    		$('#Management').hide();
    		$('#Coding').hide();
    		$('#Quizzing').hide();
