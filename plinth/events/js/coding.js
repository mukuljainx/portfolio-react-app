...
$( "select" )
	.change(function() {
    	...
    	if(str == "Robotics")
    	{
            ...
            window.location.replace("./coding.html#/transporter");
            $('#Robotics').show();
    		$('#Management').hide();
    		$('#Coding').hide();
    		$('#Quizzing').hide();
    	...
    	if(str == "Management")
    	{
            ...
            window.location.replace("./coding.html#/sif");            
            $('#Robotics').hide();
    		$('#Management').show();
    		$('#Coding').hide();
    		$('#Quizzing').hide();
        ...
        if(str == "Quizzing")
        {
            ...
            window.location.replace("./coding.html#/bigq");            
    		$('#Robotics').hide();
    		$('#Management').hide();
    		$('#Coding').hide();
    		$('#Quizzing').show();
    	...
    	if(str == "Astronomy")
    	{
            ...
            window.location.replace("./coding.html#/astrohunt");
    		$('#Robotics').hide();
    		$('#Management').hide();
    		$('#Coding').hide();
    		$('#Quizzing').hide();
    	...
    	if(str == "Literary")
    	{
            ...
            window.location.replace("./coding.html#/finderskeepers");
    		$('#Robotics').hide();
    		$('#Management').hide();
    		$('#Coding').hide();
    		$('#Quizzing').hide();
